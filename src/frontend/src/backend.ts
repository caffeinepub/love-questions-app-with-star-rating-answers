...
export class Backend implements backendInterface {
    ...
    async getAllAnswers(): Promise<Array<Answer>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllAnswers();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async saveAnswer(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAnswer(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
